...
import { PermissionsModal } from "../components/user/PermissionsModal";
import { PasswordModal } from "../components/user/PasswordModal";

// Componentes de UI comunes (puedes moverlos a un archivo common/UI.jsx)
...
const Btn = ({ children, Icon, ...props}) => (
    <button {...props} className="flex items-center gap-2 px-4 py-2 bg-brand-primary text-white rounded-lg shadow-md hover:bg-brand-secondary transition-colors">
        ...
        <div className="max-w-7xl mx-auto">
          <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
            ...
            <div className="flex items-center gap-2 mt-4 sm:mt-0 w-full sm:w-auto">
              ...
              <Btn onClick={() => setModalState({ type: 'create' })} Icon={UserPlusIcon}>Crear Usuario</Btn>
            </div>
          </header>
