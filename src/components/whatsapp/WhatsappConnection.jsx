        ...
        if (isStuck) {
            return (
                <div className="text-center">
                    ...
                    <button onClick={onForceSync} className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg flex items-center justify-center">
            ...
            case 'disconnected':
                return (
                    <>
                        ...
                        <p className="text-center text-slate-500 mb-4">Tu cuenta de WhatsApp no está conectada.</p>
                        <button onClick={onConnect} disabled={loading} className="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-lg flex items-center justify-center disabled:opacity-50">
            ...
            case 'waiting-qr':
                return (
                    <div className="text-center">
                        ...
                        <p className="mb-4 font-medium">Escanea este código desde tu teléfono</p>
