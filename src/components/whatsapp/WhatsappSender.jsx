            ...
            <form onSubmit={onSend}>
                <div className="mb-4">
                    ...
                    <textarea
                        ...
                        rows="5"
                        className="w-full p-3 border rounded-lg text-sm bg-white dark:bg-slate-700 border-slate-300 dark:border-slate-600 focus:ring-2 focus:ring-brand-primary"
                        placeholder="Escribe tu mensaje aquí..."
                        disabled={!isConnected || loading}
                    />
                </div>
                <div className="mb-4">
                    <label htmlFor="numbers" className="block text-sm font-medium mb-1.5">Números (uno por línea):</label>
                    <textarea
