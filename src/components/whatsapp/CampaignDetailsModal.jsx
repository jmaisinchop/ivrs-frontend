...
const CampaignDetailsModal = ({ isOpen, onClose, campaignId }) => {
    ...
    const filteredContacts = details?.contacts.filter(contact =>
                                ...
                                {loading ? (
                                    ...
                                    <>
                                        ...
                                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 my-6">
                                            ...
                                            <StatCard title="Pendientes" value={details.stats.pending || 0} colorClass="text-yellow-600" />
                                            <StatCard title="Enviados" value={details.stats.sent || 0} colorClass="text-green-600" />
                                            <StatCard title="Fallidos" value={details.stats.failed || 0} colorClass="text-red-600" />
                                        </div>
